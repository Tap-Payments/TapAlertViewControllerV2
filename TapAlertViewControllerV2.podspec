#
#  Be sure to run `pod spec lint TapAlertViewControllerV2.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = "Custom alert view controller for iOS.Custom alert view controller for iOS."

  spec.homepage     = "https://github.com/Tap-Payments/TapAlertViewControllerV2"
  ...
  spec.source       = { :git => "https://github.com/Tap-Payments/TapAlertViewControllerV2.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "TapAlertViewControllerV2/TapAlertViewControllerV2/Source/**/*.{h,m,swift}"
  ...
  spec.dependency "TapVisualEffectViewV2"
